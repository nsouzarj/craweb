...
INSERT INTO solicitacao (referenciasolicitacao, datasolictacao, dataprazo, observacao, instrucoes, complemento, justificativa, tratposaudiencia, numcontrole, tempreposto, convolada, horaudiencia, statusexterno, processo_id, idusuario, valor, valordaalcada, emailenvio, pago, grupo, propostaacordo, audinterna, lide, avaliacaonota, textoavaliacao) VALUES
(1001, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + INTERVAL '30 days', 'Solicitação de protesto', 'Protocolar no cartório', 'Documento anexo', 'Débito em atraso', 'Enviar após audiência', 'CTRL-001', false, true, '10:00', 'CONFIRMAR', 1, 2, 500.00, 1000.00, 'contato@cliente.com.br', 'false', 1, false, true, 'S', 5, 'Atendimento excelente'),
(1002, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + INTERVAL '15 days', 'Solicitação de cobrança', 'Enviar notificação extrajudicial', 'Contrato anexo', 'Inadimplemento contratual', 'Tratar após reunião', 'CTRL-002', true, false, '14:30', 'REJEITAR', 2, 3, 1200.50, 2000.00, 'financeiro@cliente.com.br', 'true', 2, true, false, 'N', 4, 'Bom serviço')
ON CONFLICT DO NOTHING;